...
| 문제 | 제목 | 레벨 | 소스 코드 | 테스트 코드 | 설명 |
|---|---|---|---|---|---|
| [링크](https://programmers.co.kr/learn/courses/30/lessons/77484) | 로또의 최고 순위와 최저 순위 | Level 1 | [링크](https://github.com/jiaekim123/algorithm-integrated/blob/master/src/main/java/programmers/courses30/lesson77484/Solution.java) | [링크](https://github.com/jiaekim123/algorithm-integrated/blob/master/src/test/java/programmers/courses30/lesson77484/SolutionTest.java) | |